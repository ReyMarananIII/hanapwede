...
export default function EditJob() {
  ...
  useEffect(() => {
    const fetchJobData = async () => {
      ...
      try {
        // Fetch job details
        const jobResponse = await fetch(`http://194.163.40.84/api/job/${jobId}/`, {
          headers: {
  ...
  const fetchDisabilityTags = async () => {
    try {
      const response = await fetch("http://194.163.40.84/api/disability-tags/", {
        headers: {
          Authorization: `Token ${authToken}`,
          "Content-Type": "application/json",
        },
  ...
  const fetchJobDisabilityTags = async (jobId) => {
    try {
      const response = await fetch(`http://194.163.40.84/api/job-post-disability-tags/${jobId}/`, {
        headers: {
          Authorization: `Token ${authToken}`,
          "Content-Type": "application/json",
        },
  ...
  const fetchJobTags = async (jobId) => {
    try {
      const response = await fetch(`http://194.163.40.84/api/job-post-tags/${jobId}/`, {
        headers: {
          Authorization: `Token ${authToken}`,
          "Content-Type": "application/json",
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://194.163.40.84/api/edit-job-post/${jobId}/`, {
        method: "PUT",
        headers: {
          Authorization: `Token ${authToken}`,
          "Content-Type": "application/json",
