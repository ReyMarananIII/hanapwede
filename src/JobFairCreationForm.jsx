...
import { X, Loader, Calendar, Clock, MapPin, Phone, Mail, Plus } from "lucide-react"

export default function JobFairCreationForm({ onClose, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.success) {
      setError(result.error || "Failed to create job fair. Please try again.")
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full p-6 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">Create New Job Fair</h2>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700">
                      You don't have any jobs posted yet. Please create jobs first before creating a job fair.
                    </p>
                  </div>
                </div>
              </div>
