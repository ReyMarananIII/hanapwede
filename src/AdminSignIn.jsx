...
export default function AdminSignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://194.163.40.84/api/admin-login/", {
        method: "POST",
      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-64px)] px-4 py-12">
        <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-md">
          <div className="text-center">
            ...
            <h1 className="mt-4 text-2xl font-bold tracking-tight text-gray-900">Administrator Login</h1>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  placeholder="admin@hanapwede.com"
                />
              </div>
            </div>
